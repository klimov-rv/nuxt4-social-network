    ...
    <el-main>
      <el-card class="mb-5">
        <el-space wrap size="large">
          ...
          <ElButton @click="hello"> Open Dialog </ElButton>
          ...
          <LazyElButton
            type="warning"
            @click="$message('come from Lazy Button')"
          >
            Lazy Button
          </LazyElButton>
          <el-text class="mx-1" size="large"> el-text </el-text>
          <el-link
      ...
      <ElementPlusFormCard />
      <ElementPlusTableCard v-loading="loading" />
      <ElementPlusTreeCard />
      <ElementPlusDataCard />
      <ElementPlusNavigationCard />
      ElementPlusOtherCard
      <ElementPlusOtherCard />
    </el-main>
    <el-footer>
      <!-- <ElementPlusIconCard /> -->
